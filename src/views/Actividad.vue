  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Afianzar algunos de los conceptos más importantes asociados a la usabilidad y técnicas de evaluación de interfaces gráficas para sistemas <i>software</i>
