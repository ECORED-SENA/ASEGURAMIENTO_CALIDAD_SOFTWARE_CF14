...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center
      .col-lg-10
        .jumbotron-1.p-2
          p.text-center <b>En resumen, la Arquitectura de la Información se centra en las siguientes acciones:</b> 
    .row.p-4.align-items-center.mb-5
      .col-lg-9
        .row.align-items-center(style='background-color:#F6F6F6; padding: 1.5rem 600px 1.5rem 6rem;margin:0 -700px 0 -6rem;') 
          .col-lg-6
              .row.align-items-center.mb-3
                .col-auto
